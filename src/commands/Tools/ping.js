...
class UserCommand extends BeemoCommand {
	...
	async chatInputRun(interaction) {
		...
		const sent = interaction.reply({ embeds: [new EmbedBuilder().setColor(`${color.invis}`).setDescription(`${emojis.custom.loading} **Currently fetching the latency, this might take a while**`)], fetchReply: true });
