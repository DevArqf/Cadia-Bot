...
// Check if the user is an Bot Owner
...
const tokenfilter = new RegExp(`${interaction.client.token.split("").join("[^]{0,2}")}|${interaction.client.token.split("").reverse().join("[^]{0,2}")}`, "g");
