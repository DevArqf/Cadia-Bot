...
class UserCommand extends BeemoCommand {
	...
	constructor(context, options) {
		super(context, {
			...options,
			description: 'Get the timezones of our devs'
		});
	}
	...
	async chatInputRun(interaction) {
		...
		const embed = new EmbedBuilder()
			...
			.addFields(
				{ name: 'Malik\'s Time:', value: `${emojis.custom.reply_start} ${get_time('AST')}`, inline: false },
				{ name: 'Navin\'s Time:', value: `${emojis.custom.reply_start} ${get_time('EST')}`, inline: false },
				{ name: 'Oreo\'s Time:', value: `${emojis.custom.reply_start} ${get_time('GMT +5')}`, inline: false },
                { name: 'Chaos\'s Time:', value: `${emojis.custom.reply_start} ${get_time('GMT +2')}`, inline: false },
