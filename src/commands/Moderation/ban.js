	...
	async chatInputRun(interaction) {
        ...
        if (userid) {
            ...
            if (Number.isNaN(userid)) {
                return await interaction.reply(`${emojis.custom.fail} You have entered something that is **not** a number!`);
            }
        ...
        const banMember = await interaction.guild.members.fetch(userid);
        ...
        // if (!interaction.member.permissions.has(PermissionsBitField.Flags.BanMembers)) {
            ...
            if (banMember.permissions.has(PermissionsBitField.Flags.Administrator)) {
                return await interaction.reply({
                    content: `${emojis.custom.fail} You **cannot** ban **staff** members or people with the **Administrator** permission!`,
                    ephemeral: true});
            }
