...
class UserCommand extends BeemoCommand {
	...
	async chatInputRun(interaction) {
        ...
        if (!user) return await interaction.reply({ content: `${emojis.custom.fail} The user \`${displayuser}\` **does not** exist within the server!`, ephemeral: true});
        ...
        switch (sub) {
            ...
            if (interaction.user.id === displayuser.id) {
                ...
                await interaction.reply({ content: `${emojis.custom.fail} You tried **giving yourself** a **hug**, it **didn't** work \`💔\``, ephemeral: true});
            ...
            if (!interactdata) return await interaction.reply({ content: `${emojis.custom.fail} That user **has not** been given any **statistics** yet!`, ephemeral: true});
            else {
            ...
            if (interaction.user.id === displayuser.id) {
                ...
                await interaction.reply({ content: `${emojis.custom.fail} You tried **slapping yourself**, you are weird.. \`👋\``, ephemeral: true});
            ...
            if (interaction.user.id === displayuser.id) {
                ...
                await interaction.reply({ content: `${emojis.custom.fail} You tried **killing yourself**, emotional damage? \`🔪\``, ephemeral: true});
            ...
            if (interaction.user.id === displayuser.id) {
                ...
                await interaction.reply({ content: `${emojis.custom.fail} You tried **kissing yourself**, feel lonely? \`💋\``, ephemeral: true});
